...
# ============================================================
# DuckMail 配置（优先 config.json，其次环境变量 .env）
# ============================================================
...
DUCKMAIL_API_BASE = str(_conf.get("duckmail_api_base") or os.getenv("DUCKMAIL_API_BASE") or "https://api.duckmail.sbs")
DUCKMAIL_BEARER = str(_conf.get("duckmail_bearer") or os.getenv("DUCKMAIL_BEARER") or "")
PROXY = str(_conf.get("proxy") or os.getenv("HTTP_PROXY") or "")
